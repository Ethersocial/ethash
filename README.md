...
https://github.com/ethersocial/wiki/wiki/Ethash

### Coding Style for C++ code:

Follow the same exact style as in [cpp-ethereum](https://github.com/ethersocial/cpp-ethereum/blob/develop/CodingStandards.txt)
